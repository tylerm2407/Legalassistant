...
Each template defines a complete step-by-step guided process for a
specific legal action, with explanations, required documents, tips,
and relevant deadlines at each step.
"""

from __future__ import annotations

from backend.workflows.engine import WorkflowStep, WorkflowTemplate
...
WORKFLOW_TEMPLATES: list[WorkflowTemplate] = [
    ...
    WorkflowTemplate(
        ...
        steps=[
            WorkflowStep(
                ...
                explanation=(
                    "Carefully read the eviction notice. Identify what type it is (nonpayment, "
                    "lease violation, no-cause, or illegal activity). Note the deadline to respond "
                    "and whether you have the right to 'cure' (fix the problem). Check that the "
                    "notice meets your state's legal requirements for format, delivery method, "
                    "and notice period."
                ),
                ...
                deadlines=["Note the response deadline on the notice (typically 3-30 days)"],
            ),
            WorkflowStep(
                id="check_validity",
                title="Check Notice Validity",
                explanation=(
                    "Verify that the eviction notice complies with your state's requirements. "
                    "Common defects include: wrong notice period, improper service method, "
                    "incorrect address, wrong amount owed, or failure to include required "
                    "legal language. An invalid notice can be grounds for dismissal."
                ),
                required_documents=["Eviction notice", "State landlord-tenant statute"],
                tips=[
                ...
                deadlines=["Do this immediately — before your response deadline"],
            ),
            WorkflowStep(
                id="gather_evidence",
                title="Gather Your Evidence",
                explanation=(
                    "Collect everything that supports your defense: rent payment receipts, "
                    "bank statements showing payments, photos of property conditions, "
                    "maintenance request records, communication with landlord (texts, emails), "
                    "and any witness information. Organize chronologically."
                ),
                required_documents=[
            ...
            WorkflowStep(
                ...
                explanation=(
                    "File a written answer with the court before the deadline. Your answer should "
                    "deny allegations that aren't true and list your defenses. Common defenses include: "
                    "improper notice, retaliatory eviction, discrimination, breach of habitability, "
                    "payment already made, or waiver by acceptance of rent."
                ),
                required_documents=["Court answer form", "Filing fee or fee waiver application"],
                tips=[
            ...
            WorkflowStep(
                ...
                explanation=(
                    "If a hearing isn't automatically scheduled after you file your answer, "
                    "request one from the court clerk. Some jurisdictions also offer mediation "
                    "as an alternative — this can sometimes result in a better outcome than trial."
                ),
                ...
                deadlines=["Hearing is typically set within 1-4 weeks of filing answer"],
            ),
            WorkflowStep(
                id="prepare_case",
                title="Prepare Your Case",
                explanation=(
                    "Organize your evidence and prepare your testimony. Practice explaining your "
                    "case clearly and concisely. If you have witnesses, confirm they can attend. "
                    "Review your state's landlord-tenant laws relevant to your defenses."
                ),
                required_documents=[
            ...
            WorkflowStep(
                ...
                explanation=(
                    "Attend your hearing on time. Be respectful and address the judge as "
                    "'Your Honor.' Present your case clearly: state your defenses, show your "
                    "evidence, and call any witnesses. Listen carefully to the landlord's "
                    "arguments and be prepared to respond."
                ),
    ...
    WorkflowTemplate(
        ...
        steps=[
            WorkflowStep(
                ...
                explanation=(
                    "Check that your case qualifies for small claims court. Verify: the amount "
                    "is within your state's limit ($2,500-$25,000 depending on state), you're "
                    "suing in the right county (where defendant lives or where the issue happened), "
                    "and the statute of limitations hasn't expired."
                ),
                required_documents=["Evidence of the amount owed", "Defendant's address"],
                tips=[
                ...
                deadlines=["Check the statute of limitations for your type of claim"],
            ),
            WorkflowStep(
                id="send_demand",
                title="Send a Demand Letter",
                explanation=(
                    "Before filing, send a formal demand letter to the other party via certified "
                    "mail. This is required in some states and always good practice. State what's "
                    "owed, why, and give a deadline (14-30 days) to pay before you file suit."
                ),
            ...
            WorkflowStep(
                ...
                explanation=(
                    "Go to the courthouse (or file online if available) and complete the small "
                    "claims filing form. Pay the filing fee. You'll receive a case number and "
                    "hearing date. The court will issue papers to be served on the defendant."
                ),
                required_documents=["Completed claim form", "Filing fee", "Demand letter copy"],
                tips=[
            ...
            WorkflowStep(
                ...
                explanation=(
                    "The defendant must be officially notified of the lawsuit. Service methods "
                    "vary by state: personal service, certified mail, or process server. The "
                    "defendant must be served before the hearing date."
                ),
                required_documents=["Court papers to serve", "Proof of service form"],
                tips=[
            ...
            WorkflowStep(
                ...
                explanation=(
                    "Attend the hearing with all your evidence organized. Present your case "
                    "clearly: what happened, what's owed, and your evidence. Show the demand "
                    "letter and proof it was sent. Be prepared for the defendant's arguments."
                ),
                required_documents=[
    ...
    WorkflowTemplate(
        ...
        description="Step-by-step process to seal or expunge your criminal record",
        ...
        steps=[
            WorkflowStep(
                ...
                explanation=(
                    "Research your state's expungement/sealing laws to determine if you're "
                    "eligible. Factors include: type of offense, time since completion of "
                    "sentence, whether you have subsequent offenses, and whether all fines "
                    "and restitution are paid."
                ),
                ...
                deadlines=["Waiting periods: typically 1-10 years after sentence completion"],
            ),
            WorkflowStep(
                id="obtain_records",
                title="Obtain Your Records",
                explanation=(
                    "Get a complete copy of your criminal record from the state police, "
            ...
            WorkflowStep(
                ...
                explanation=(
                    "Fill out the expungement petition form for your court. Include all "
                    "required information: case numbers, charges, dispositions, evidence of "
                    "rehabilitation, and reasons for seeking expungement. Many courts have "
                    "self-help resources."
                ),
                required_documents=[
            ...
            WorkflowStep(
                ...
                explanation=(
                    "File the completed petition with the court that handled your original "
                ...
                deadlines=["DA must usually be served within a specific period after filing"],
            ),
            WorkflowStep(
                id="attend_hearing",
                title="Attend the Hearing",
                explanation=(
                    "Attend the expungement hearing. Be prepared to explain your rehabilitation "
                    "and why expungement is warranted. The DA may or may not object. The judge "
                    "will consider the nature of the offense, time elapsed, and your conduct "
                    "since the conviction."
                ),
                required_documents=["Filed petition copy", "Evidence of rehabilitation"],
                tips=[
            ...
            WorkflowStep(
                ...
                explanation=(
                    "After the court grants expungement, verify that the records have actually "
                    "been sealed or destroyed. Check with the court, state police, and any "
                    "online databases. It can take several weeks for records to be updated "
                    "across all systems."
                ),
                ...
                deadlines=["Allow 30-90 days for records to be updated across systems"],
            ),
        ],
    ),
    # --- File Wage Complaint ---
    WorkflowTemplate(
        ...
        steps=[
            WorkflowStep(
                ...
                explanation=(
                    "Gather all evidence of hours worked and pay received. Compare your actual "
                    "hours to what you were paid. Calculate the exact amount owed, including "
                    "any overtime, minimum wage violations, or unauthorized deductions."
                ),
                required_documents=[
                    "Pay stubs",
                ...
                deadlines=["FLSA claims: 2-year limit (3 years for willful violations)"],
            ),
            WorkflowStep(
                id="file_complaint",
                title="File with State Labor Board",
                explanation=(
                    "File a wage complaint with your state's Department of Labor or wage board. "
                ...
                deadlines=["State filing deadlines vary — typically 2-6 years from the violation"],
            ),
            WorkflowStep(
                id="follow_up",
                title="Follow Up on Investigation",
                explanation=(
                    "After filing, the labor board will investigate. They may contact your employer "
                    "and request records. Stay responsive to any requests from the investigator. "
                    "The process typically takes 2-6 months."
                ),
                required_documents=["Case number and investigator contact info"],
                tips=[
                ...
                deadlines=["Respond to investigator requests within the timeframes given"],
            ),
            WorkflowStep(
                id="escalate",
                title="Escalate if Needed",
                explanation=(
                    "If the labor board doesn't resolve your case, or if the amount is significant, "
                    "consider filing in small claims court or hiring an employment attorney. Many "
                    "employment attorneys work on contingency for wage theft cases."
                ),
                required_documents=["Labor board determination", "All original documentation"],
                tips=[
    ...
    WorkflowTemplate(
        ...
        steps=[
            WorkflowStep(
                ...
                explanation=(
                    "Before deciding to fight, understand your options: pay the fine (accept guilt "
                    "and points), attend traffic school (may avoid points), or fight in court "
                    "(plead not guilty). Consider the points impact on your license and insurance."
                ),
                ...
                deadlines=["Response deadline on the ticket (usually 15-30 days)"],
            ),
            WorkflowStep(
                id="prepare_defense",
                title="Prepare Your Defense",
                explanation=(
                    "Build your defense by gathering evidence. Request the officer's notes, radar "
                ...
                deadlines=["Discovery requests should be made promptly after pleading not guilty"],
            ),
            WorkflowStep(
                id="request_hearing",
                title="Request a Hearing",
                explanation=(
                    "Plead not guilty and request a hearing. This can usually be done online, "
                    "by mail, or in person. You may be able to request a trial by written "
                    "declaration in some states (no court appearance needed)."
                ),
                ...
                deadlines=["Plea must be entered before the deadline on the ticket"],
            ),
            WorkflowStep(
                id="present_case",
                title="Present Your Case",
                explanation=(
                    "Attend the hearing and present your defense. If the officer doesn't appear, "
                    "request dismissal. Present your evidence clearly. Common defenses: equipment "
                    "not calibrated, speed necessary for safety, incorrect identification of vehicle."
                ),
                required_documents=["All evidence and copies", "Calibration records (if obtained)"],
                tips=[
                    "Dress professionally",
    ...
    WorkflowTemplate(
        ...
        description="Step-by-step guide to creating a simple last will and testament",
        domain="family_law",
        ...
        steps=[
            WorkflowStep(
                ...
                explanation=(
                    "Make a comprehensive list of everything you own: real estate, bank accounts, "
                    "retirement accounts, investments, vehicles, valuable personal property, "
                ...
                deadlines=["No deadline, but don't delay — unexpected events happen"],
            ),
            WorkflowStep(
                id="choose_beneficiaries",
                title="Designate Beneficiaries",
                explanation=(
                    "Decide who will receive your assets. You can leave specific items to specific "
                    "people (specific bequests) or divide the remainder (residuary estate) among "
                    "beneficiaries by percentage. Name alternate beneficiaries in case your "
                    "primary choices predecease you."
                ),
                required_documents=["Beneficiary list with full legal names and relationships"],
                tips=[
            ...
            WorkflowStep(
                ...
                explanation=(
                    "Select a trusted person to carry out your will (executor/personal representative). "
                    "This person will manage your estate, pay debts, and distribute assets. Choose "
                    "someone organized, trustworthy, and willing. Name an alternate executor."
                ),
                required_documents=["Executor's full legal name and contact information"],
                tips=[
            ...
            WorkflowStep(
                ...
                explanation=(
                    "Create the will document. You can use a reputable online service, a template "
                    "from your state court, or hire an estate planning attorney. The will must "
                    "clearly state it's your will, name beneficiaries and bequests, appoint an "
                    "executor, and include required legal language for your state."
                ),
                required_documents=["Asset inventory", "Beneficiary list", "Executor information"],
                tips=[
            ...
            WorkflowStep(
                ...
                explanation=(
                    "Sign the will in the presence of witnesses as required by your state. Most "
                    "states require two witnesses who are not beneficiaries. Some states recognize "
                    "self-proving affidavits (notarized) which simplify probate later. Store the "
                    "original in a safe, accessible place."
                ),
                required_documents=["Drafted will", "Two witnesses", "Notary (recommended)"],
                tips=[
...
def get_all_templates() -> list[WorkflowTemplate]:
    ...
    Returns:
        Complete list of WorkflowTemplate objects.
    """
...
def get_template_by_id(template_id: str) -> WorkflowTemplate | None:
    ...
    Returns:
        The matching WorkflowTemplate, or None if not found.
    """
    return next((t for t in WORKFLOW_TEMPLATES if t.id == template_id), None)


def get_templates_by_domain(domain: str) -> list[WorkflowTemplate]:
    """Return all templates for a specific legal domain.

    Args:
        domain: The legal domain to filter by.

    Returns:
        List of WorkflowTemplate objects matching the domain.
    """
    return [t for t in WORKFLOW_TEMPLATES if t.domain == domain]
